...
const Hero = () => {
  ...
  const quoteParallax = useParallax({ speed: 0.1, direction: 'up' });
  const featureParallax = useParallax({ speed: 0.05, direction: 'down', reverseDirection: true });
  const imageParallax = useParallax({ speed: 0.08, direction: 'up', startOffset: 10 });
  const brandParallax = useParallax({ speed: 0.03, direction: 'up' });
    ...
    <div className="flex flex-col">
      ...
      <section className="relative bg-gradient-to-b from-white to-brand-creamy-ivory pt-24 pb-16 md:pt-32 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="flex justify-center mb-6" style={quoteParallax.style}>
            ...
            <h1 className="font-italiana text-4xl md:text-5xl lg:text-6xl uppercase tracking-wide mb-8 text-shimmer text-white text-shadow-lg" style={featureParallax.style}>
              Natural holistic apothecary
            </h1>
            <p className="font-karla text-base md:text-lg mb-12 text-white leading-relaxed max-w-2xl mx-auto text-shadow" style={quoteParallax.style}>
            ...
            <div className="flex justify-center" style={{...quoteParallax.style, transitionDelay: '0.2s'}}>
              <Link to="/products">
      ...
      <section className="relative bg-brand-blush-rose/10 py-12 z-10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <Feather className="mx-auto mb-6 text-brand-orchid-pink h-8 w-8 opacity-80 subtle-breathe" style={featureParallax.style} />
            <blockquote className="font-italiana text-2xl md:text-3xl italic mb-6 text-brand-dark" style={quoteParallax.style}>
              "True beauty is not merely what we see on the surface, but the radiance that emanates from balanced wellness within."
            </blockquote>
            <p className="font-karla text-brand-deep-teal tracking-widest uppercase text-sm" style={{...featureParallax.style, transitionDelay: '0.1s'}}>— Datin Norehan</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-0 bg-white">
        <div className="max-w-full mx-auto">
          <div className="text-center mb-10 pt-16" style={imageParallax.style}>
      ...
      <section className="py-24 bg-brand-creamy-ivory/50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block mb-6 relative" style={brandParallax.style}>
              <span className="inline-block w-12 h-[1px] bg-brand-muted-rose"></span>
              <span className="inline-block mx-4 font-karla text-sm tracking-widest text-brand-muted-rose">ESSENCE</span>
              <span className="inline-block w-12 h-[1px] bg-brand-muted-rose"></span>
            </div>
            <h2 className="font-italiana text-2xl md:text-3xl uppercase tracking-wide mb-8" style={imageParallax.style}>The DNA Philosophy</h2>
            <p className="font-karla text-lg text-brand-soft-gray leading-relaxed mb-8 max-w-2xl mx-auto" style={quoteParallax.style}>
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-12" style={brandParallax.style}>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 mb-16">
          <div className="flex justify-center mb-8" style={brandParallax.style}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-10">
            ...
            <Link to="/products" className="group">
              <div className="aspect-square bg-white relative overflow-hidden mb-4 shadow-sm">
                <div className="w-full h-full" style={imageParallax.style}>
                  <img 
            ...
            <Link to="/rituals" className="group">
              <div className="aspect-square bg-white relative overflow-hidden mb-4 shadow-sm">
                <div className="w-full h-full" style={{...imageParallax.style, transitionDelay: '0.1s'}}>
                  <img 
            ...
            <Link to="/articles" className="group">
              <div className="aspect-square bg-white relative overflow-hidden mb-4 shadow-sm">
                <div className="w-full h-full" style={{...imageParallax.style, transitionDelay: '0.2s'}}>
                  <img 
            ...
            <div className="group relative">
              <div className="aspect-square bg-white relative overflow-hidden mb-4 shadow-sm">
                <div className="w-full h-full" style={{...imageParallax.style, transitionDelay: '0.3s'}}>
                  <img 
      ...
      <section className="quote-container bg-gradient-to-r from-brand-blush-rose/10 to-brand-lavender-mist/10">
        ...
        <div className="container mx-auto max-w-3xl text-center px-4">
          <Feather className="mx-auto mb-6 text-brand-orchid-pink h-8 w-8 opacity-80 subtle-breathe" style={quoteParallax.style} />
          <blockquote className="font-italiana text-2xl md:text-3xl italic mb-6 text-brand-dark" style={featureParallax.style}>
            "Our rituals are not merely routines, but sacred moments where we reconnect with ourselves and honor our wellbeing."
          </blockquote>
          <p className="font-karla text-brand-deep-teal tracking-widest uppercase text-sm" style={imageParallax.style}>— Datin Norehan</p>
        </div>
      </section>
      ...
      <section className="w-full h-[50vh] md:h-[60vh] bg-cover bg-center relative overflow-hidden" 
        ...
        <div className="container mx-auto h-full flex items-center relative z-10">
          <div className="px-6 md:px-8 py-8 md:py-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg shadow-lg max-w-lg" style={brandParallax.style}>
      ...
      <section className="py-24 bg-gradient-to-r from-brand-lavender-mist/10 via-brand-creamy-ivory to-brand-blush-rose/10 border-t border-brand-blush-rose/10">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <div className="inline-block mb-6" style={brandParallax.style}>
              <Sparkles className="h-5 w-5 text-brand-orchid-pink mx-auto subtle-breathe" />
            </div>
            <h2 className="font-italiana text-2xl uppercase tracking-wide mb-8" style={quoteParallax.style}>Join Our Inner Circle</h2>
            <p className="font-karla text-brand-soft-gray mb-12 max-w-lg mx-auto" style={featureParallax.style}>
            ...
            <p className="text-xs text-brand-soft-gray/80" style={brandParallax.style}>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-lg text-center px-4">
          <blockquote className="font-italiana text-xl md:text-2xl text-brand-dark italic" style={quoteParallax.style}>
            "When we embrace nature's gifts with intention and knowledge, we unlock the path to true harmony and vitality."
          </blockquote>
          <p className="font-karla text-brand-muted-rose mt-4 tracking-widest uppercase text-sm" style={featureParallax.style}>— Datin Norehan</p>
        </div>
      </section>
    </div>
  );
