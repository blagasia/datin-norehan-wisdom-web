...
const Ask = () => {
  return (
    <div className="min-h-screen flex flex-col bg-soft-purple/10">
      <Navbar />
      <main className="flex-grow">
        {/* Hero Section */}
        <div className="py-16 md:py-24 bg-gradient-to-r from-natural-peach/30 to-soft-purple/30">
        ...
        <div className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-playfair text-3xl font-bold text-center mb-12">Community Guidelines & FAQs</h2>
              ...
              <div className="space-y-8">
                ...
                <div className="border-b border-natural-peach/30 pb-6">
                  <h3 className="font-playfair text-xl font-semibold mb-3">How do I engage with the community?</h3>
                  <p className="text-natural-gray">
                ...
                <div className="pb-6">
                  <h3 className="font-playfair text-xl font-semibold mb-3">What happens after I submit my question?</h3>
                  <p className="text-natural-gray">
