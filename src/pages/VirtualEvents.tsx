    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-b from-natural-green/10 to-white py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-12 text-center">
              <h1 className="font-playfair text-4xl md:text-5xl font-bold mb-6">Workshops & Events</h1>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="font-playfair text-3xl font-bold mb-8 text-center">Online Workshops & Courses</h2>
            <EventsGrid />
          </div>
        </section>
